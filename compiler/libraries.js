var libs = {
  ...
  "sys.vram.draw_square": [
    ...
    "  arg int length",
    "  arg bool data true",
    "  var int x_offset x+length",
    "  var int y_offset y+length",
    "  var int counter",
    "  var int x_current",
    "  var int y_current",
    "  length++",
  ...
  "sys.vram.draw_circle": [
    ...
    "  var sint x0 x1:0",
    "  var sint y0 y1:0",
    "  var sint radius radius0:0",
    "  var sint minustwo -2",
    "  var sint f 1 - radius",
    "  var sint dx 1",
    "  var sint dy minustwo * radius",
    "  var sint x 0",
    "  var sint y radius",
    "  ",
    "  sys.vram.set_pixel(x0:0, y0 + radius,data)",
    "  sys.vram.set_pixel(x0:0, y0 - radius,data)",
    "  sys.vram.set_pixel(x0 + radius, y0:0,data)",
    "  sys.vram.set_pixel(x0 - radius, y0:0,data)",
    "  ",
    "  while x < y",
    "    if f >= 0",
    ...
    "    f += dx",
    "  ",
    "    sys.vram.set_pixel(x0 + x, y0 + y,data)",
    "    sys.vram.set_pixel(x0 + y, y0 + x,data)",
    "    sys.vram.set_pixel(x0 - y, y0 + x,data)",
    "    sys.vram.set_pixel(x0 - x, y0 + y,data)",
    "    sys.vram.set_pixel(x0 - x, y0 - y,data)",
    "    sys.vram.set_pixel(x0 - y, y0 - x,data)",
  ...
  "sys.vram.draw_line": [
    ...
    " ",
    "  while true",
    "    sys.vram.set_pixel(x0:0,y0:0,data)",
    "    minus_dx = 0 - dx",
    "    if x0 == x1 ",
    "      if y0 == y1",
    "        return 0",
  ...
  "sys.print_string": [
    ...
    "  arg int x ",
    "  arg int y",
    "  var int pointer string:0",
    "  var int char *pointer",
    "  ",
    "  while char > 0",
  ...
  "sys.print_int_as_hex": [
    "def sys.print_int_as_hex",
    "  arg int num",
    "  arg int x",
    "  arg int y",
    "  arg bool print_all_places false",
  ...
  "  arg bool print_all_places false",
  "",
  "  var int num signed_num : 0",
  "  var bool negative",
  "",
  "  if signed_num < 1",
  "    negative = true",
  "    signed_num = 0 - signed_num",
  "    num = signed_num : 0",
  "  ",
  "  var int x_offset x",
  "  var bool is_rendering",
  "",
  "  if print_all_places | negative",
  "    if negative",
  ...
  "sys.print_long":[
   ...
   "  var bool did_render",
   "  var long power",
   "  var array powers (long)[1000000000,100000000,10000000,1000000,100000,10000,1000,100,10]",
   "",
   "  for var int i; i < powers.len(); i++",
   "    power = powers[i]",
   "    char = 48",
   "    while num > power",
   "      did_render = true",
