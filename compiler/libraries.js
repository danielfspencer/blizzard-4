const libs = {
  ...
  "sys.s32_rshift": [
    ...
    "",
    "  if negative",
    "    a_high = a_high | 0b1000000000000000",
    "",
    "  return a_high..a_low"
  ],
  "sys.s32_greater": [
  ...
  "sys.vram.render_char": [
    ...
    "  char_code -= 32",
    "  ",
    "  var u16 char_pointer",
    "  var u16 char_offset char_code",
    ...
    "",
    "  var u16 vram_pointer 6152",
    "  var u16 vram_offset_x x >>",
    "  var u16 vram_offset_y y",
    "  repeat 6",
  ...
  "sys.print_u32":[
   ...
   "  var bool did_render",
   "  var u32 power",
   "  var array powers (u32)[1000000000,100000000,10000000,1000000,100000,10000,1000,100,10]",
   "",
   "  for var u16 i; i < powers.len(); i++",
   "    power = powers[i]",
   "    char = 48",
   "    while num > power",
   "      did_render = true",
  ...
  "sys.signatures": [
    ...
    "sig sys.array_pointer(u16 index, u16 item_size, u16 base_addr) -> u16",
    "sig sys.rom_to_ram_copy(u16 origin_address, u16 target_address, u16 length) -> u16",
    "sig sys.ram_to_ram_copy(u16 origin_address, u16 target_address, u16 length) -> u16",
    "sig sys.rom_to_global_ram_copy(u16 origin_address, u16 target_address, u16 length) -> u16",
    "sig sys.global_ram_to_ram_copy(u16 origin_address, u16 target_address, u16 length) -> u16",
    "sig sys.ram_to_global_ram_copy(u16 origin_address, u16 target_address, u16 length) -> u16",
    "sig sys.global_ram_to_global_ram_copy(u16 origin_address, u16 target_address, u16 length) -> u16",
