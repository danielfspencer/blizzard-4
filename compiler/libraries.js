const libs = {
  ...
  "sys.u32_lshift": [
    ...
    "  let u16 a_high = a:0",
    "  let u16 a_low = a:1",
    "  let u16 carry = a_low & 0b1000000000000000",
    "  carry += 0xffff",
    "  {copy alu.ov &carry}",
    "  a_high = a_high <<",
    "  a_low = a_low <<",
  ...
  "sys.array_set": [
    ...
    "  let u16 offset = item_size * index",
    "  base_addr += offset",
    "",
  ...
  "sys.vram.render_char": [
    ...
    "  let u16 vram_offset_x = x >>",
    "  let u16 vram_offset_y = y",
    "  repeat 6",
  ...
  "sys.print_u32":[
   ...
   "  let u32 power",
   "  let array powers = (u32)[1000000000,100000000,10000000,1000000,100000,10000,1000,100,10]",
   "",
   "  for let u16 i = 0; i < powers.len(); i++",
   "    power = powers[i]",
   "    char = 48",
   "    while num > power",
   "      did_render = true",
